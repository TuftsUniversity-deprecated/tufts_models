module AttachedFiles
  ...
  def remote_url_for(name, extension)
      ...
      if datastreams[name] && datastreams[name].dsLocation
        datastreams[name].dsLocation
      else
  ...
  def local_path_for(name, extension=nil)
    ...
    if datastreams[name] && datastreams[name].dsLocation
      datastreams[name].dsLocation.sub('http://bucket01.lib.tufts.edu', Settings.object_store_root)
    else
