...
gem 'active-fedora', git: 'https://github.com/projecthydra/active_fedora.git', ref: '0b14b33'
gem 'om', git: 'https://github.com/projecthydra/om.git', ref: 'd147b1a'
gem 'hydra-editor', '0.0.1' 
